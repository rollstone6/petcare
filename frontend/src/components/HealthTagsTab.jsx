...
export default function HealthTagsTab({ pets }) {
  ...
  if (pets.length === 0) {
    return (
      <div className="text-center py-10">
        ...
        <p className="text-sm text-gray-300 mt-1">去个人中心 → 品种档案添加宠物后，可在此设置健康标签</p>
      </div>
    )
  }
    ...
    <div className="mt-3">
      ...
      {selectedPet && (
        <>
          ...
          {/* 保存按钮 */}
          <div className="sticky bottom-20 mt-6 bg-white p-3 rounded-xl shadow-lg border border-gray-100">
