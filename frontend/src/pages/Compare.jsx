                    ...
                    <tr>
                      ...
                      {selectedProducts.map(p => (
                        <td key={p.id} className="p-3 md:p-4 text-center">
                          <span className={`font-bold ${p.safety_score >= 70 ? 'text-green-500' : p.safety_score >= 50 ? 'text-yellow-500' : 'text-red-500'}`}>
                            ⭐ {p.safety_score}
                          </span>
                        </td>
                      ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3">
              {products.map(p => (
                ...
                >
                  ...
                  <span className={`text-sm md:text-base font-bold ${p.safety_score >= 70 ? 'text-green-500' : 'text-yellow-500'}`}>
                    {p.safety_score}
                  </span>
                </div>
              ))}
